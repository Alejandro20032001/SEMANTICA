...
% R.6.- Si el pez es de tamaño medio, tiene dientes puntiagudos, vive en
% ríos de todo %el mundo y posee canales laberínticos para respirar
% fuera del agua ENTONCES %pertenece al orden de los anabatidos.


esAnabatico(X):- esTamanioMedio(X),tieneDientesPuntiagudos(X),ViveEnRio(X,_).
